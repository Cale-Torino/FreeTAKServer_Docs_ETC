...
class MainConfig:
    ...
    #
    AlternateConfig = str(os.environ.get('FTS_CONFIG_PATH', 'C:\\python\\Lib\\site-packages\\FreeTAKServer\\FTSConfig.yaml'))
    ...
    if os.path.exists(AlternateConfig):
        ...
        if "MainPath" in yamlConfig.keys():
            ...
            MainPath = str(Path(fr'C:\\python\\Lib\\site-packages\\FreeTAKServer'))
        ...
        DBFilePath = str(os.environ.get('FTS_DB_PATH', r'C:\\python\\Lib\\site-packages\\FreeTAKServer\\FTSDataBase.db'))
